...
bool XBTimeZone::SetTimeZoneInfo(const MINI_TZI* tzi)
{
  ...
  if (ExQueryNonVolatileSetting(XC_USER_SETTINGS, &type, &eepromdata, sizeof(eepromdata), &size) <
      0)
  {
...
void XBTimeZone::SettingOptionsTimezonesFiller(const CSetting* setting,
