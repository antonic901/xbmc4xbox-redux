...
protected:
  ...
  CInfoScanner() : m_showDialog(false), m_handle(NULL), m_bRunning(false), m_bCanInterrupt(false), m_bClean(false) {}
  ...
  bool m_bCanInterrupt; //!< Whether or not scanner is currently interruptible
