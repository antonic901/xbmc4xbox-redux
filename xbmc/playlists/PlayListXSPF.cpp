...
static char const* LOCATION_TAGNAME = "location";
static char const* PLAYLIST_TAGNAME = "playlist";
static char const* TITLE_TAGNAME = "title";
static char const* TRACK_TAGNAME = "track";
static char const* TRACKLIST_TAGNAME = "trackList";
...
CPlayListXSPF::CPlayListXSPF(void) {}
...
bool CPlayListXSPF::Load(const std::string& strFileName)
{
  ...
  {
    CLog::Log(LOGERROR, "Error parsing XML file %s (%i, %i): %s", strFileName.c_str(), xmlDoc.ErrorRow(),
