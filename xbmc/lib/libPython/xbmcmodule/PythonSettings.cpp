...
namespace PYXBMC
{
  PyObject* Settings_New(PyTypeObject *type, PyObject *args, PyObject *kwds)
  {
    ...
    CStdString scriptUUID = cScriptUUID;

    AddonPtr addon;
    if (CAddonMgr::Get().GetAddon(CStdString(scriptUUID), addon, ADDON::ADDON_SCRIPT))
    {
  ...
  PyObject* Settings_OpenSettings(Settings *self, PyObject *args, PyObject *kwds)
  {
    ...
    if (ok && addon->IsType(ADDON::ADDON_SCRIPT_WEATHER))
    {
