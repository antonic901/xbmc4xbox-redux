...
static unsigned int g_ContainerAtoms[] = {
    MAKE_ATOM_NAME('m', 'o', 'o', 'v'), MAKE_ATOM_NAME('t', 'r', 'a', 'k'),
    MAKE_ATOM_NAME('u', 'd', 't', 'a'), MAKE_ATOM_NAME('t', 'r', 'e', 'f'),
    MAKE_ATOM_NAME('i', 'm', 'a', 'p'), MAKE_ATOM_NAME('m', 'd', 'i', 'a'),
    MAKE_ATOM_NAME('m', 'i', 'n', 'f'), MAKE_ATOM_NAME('s', 't', 'b', 'l'),
    MAKE_ATOM_NAME('e', 'd', 't', 's'), MAKE_ATOM_NAME('m', 'd', 'r', 'a'),
    MAKE_ATOM_NAME('r', 'm', 'r', 'a'), MAKE_ATOM_NAME('i', 'm', 'a', 'g'),
    MAKE_ATOM_NAME('v', 'n', 'r', 'p'), MAKE_ATOM_NAME('d', 'i', 'n', 'f'),
};
...
void CMusicInfoTagLoaderMP4::ParseTag(
    unsigned int metaKey, const char* pMetaData, int metaSize, CMusicInfoTag& tag, EmbeddedArt* art)
{
  switch (metaKey)
  {
...
int CMusicInfoTagLoaderMP4::ParseAtom(int64_t startOffset,
                                      int64_t stopOffset,
                                      CMusicInfoTag& tag,
                                      EmbeddedArt* art)
{
  ...
  while (currentOffset < stopOffset)
  {
    ...
    for (unsigned int containerAtom = 0;
         containerAtom < (sizeof(g_ContainerAtoms) / sizeof(unsigned int)); containerAtom++)
    {
    ...
    else if (atomName == g_MdhdAtomName)
    {
      char mdhdData[20];
...
bool CMusicInfoTagLoaderMP4::Load(const CStdString& strFileName,
                                  CMusicInfoTag& tag,
                                  EmbeddedArt* art)
{
  try
