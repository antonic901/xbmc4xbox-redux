...
public:
  ...
  virtual int apefrm_add_bin(apetag* mem_cnt,
                             unsigned long flags,
                             long sizeName,
                             char* name,
                             long sizeValue,
                             char* value) = 0;
  virtual int apefrm_add_noreplace(apetag* mem_cnt,
                                   unsigned long flags,
                                   char* name,
                                   char* value) = 0;
...
public:
  ...
  virtual apetag* apetag_init(void) { return ::apetag_init(); }
  virtual void apetag_free(apetag* mem_cnt) { return ::apetag_free(mem_cnt); }
  ...
  virtual int apefrm_add_bin(
      apetag* mem_cnt, unsigned long flags, long sizeName, char* name, long sizeValue, char* value)
  {
  ...
  virtual void apefrm_remove(apetag* mem_cnt, char* name) { return ::apefrm_remove(mem_cnt, name); }
