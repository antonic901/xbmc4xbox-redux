...
public:
  ...
  virtual const id3_ucs4_t* id3_metadata_getartist(const struct id3_tag*,
                                                   enum id3_field_textencoding*) = 0;
  virtual const id3_ucs4_t* id3_metadata_getalbum(const struct id3_tag*,
                                                  enum id3_field_textencoding*) = 0;
  virtual const id3_ucs4_t* id3_metadata_getalbumartist(const struct id3_tag*,
                                                        enum id3_field_textencoding*) = 0;
  virtual const id3_ucs4_t* id3_metadata_gettitle(const struct id3_tag*,
                                                  enum id3_field_textencoding*) = 0;
  virtual const id3_ucs4_t* id3_metadata_gettrack(const struct id3_tag*,
                                                  enum id3_field_textencoding*) = 0;
  virtual const id3_ucs4_t* id3_metadata_getpartofset(const struct id3_tag* tag,
                                                      enum id3_field_textencoding*) = 0;
  virtual const id3_ucs4_t* id3_metadata_getyear(const struct id3_tag*,
                                                 enum id3_field_textencoding*) = 0;
  virtual const id3_ucs4_t* id3_metadata_getgenre(const struct id3_tag*,
                                                  enum id3_field_textencoding*) = 0;
  virtual id3_ucs4_list_t* id3_metadata_getgenres(const struct id3_tag*,
                                                  enum id3_field_textencoding*) = 0;
  virtual const id3_ucs4_t* id3_metadata_getcomment(const struct id3_tag*,
                                                    enum id3_field_textencoding*) = 0;
  virtual const id3_ucs4_t* id3_metadata_getencodedby(const struct id3_tag* tag,
                                                      enum id3_field_textencoding*) = 0;
  virtual char id3_metadata_getrating(const struct id3_tag* tag) = 0;
  virtual const id3_ucs4_t* id3_metadata_getcompilation(const struct id3_tag* tag,
                                                        enum id3_field_textencoding*) = 0;
  virtual int id3_metadata_haspicture(const struct id3_tag*, enum id3_picture_type) = 0;
  virtual const id3_latin1_t* id3_metadata_getpicturemimetype(const struct id3_tag*,
                                                              enum id3_picture_type) = 0;
  virtual id3_byte_t const* id3_metadata_getpicturedata(const struct id3_tag*,
                                                        enum id3_picture_type,
                                                        id3_length_t*) = 0;
  virtual id3_byte_t const* id3_metadata_getuniquefileidentifier(const struct id3_tag*,
                                                                 const char* owner_identifier,
                                                                 id3_length_t*) = 0;
  virtual const id3_ucs4_t* id3_metadata_getusertext(const struct id3_tag*,
                                                     const char* description) = 0;
  virtual int id3_metadata_getfirstnonstandardpictype(const struct id3_tag*,
                                                      enum id3_picture_type*) = 0;
...
class DllLibID3Tag : public DllDynamic, DllLibID3TagInterface
{
  ...
  DEFINE_METHOD3(struct id3_frame*,
                 id3_tag_findframe,
                 (struct id3_tag const* p1, char const* p2, unsigned int p3))
  ...
  DEFINE_METHOD2(int,
                 ...
                 (union id3_field * p1, enum id3_field_textencoding p2))
  DEFINE_METHOD3(int,
                 id3_field_setstrings,
                 (union id3_field * p1, unsigned int p2, id3_ucs4_t** p3))
  ...
  DEFINE_METHOD3(int,
                 ...
                 (union id3_field * p1, id3_byte_t const* p2, id3_length_t p3))
  DEFINE_METHOD1(signed long, id3_field_getint, (union id3_field const* p1))
  DEFINE_METHOD1(enum id3_field_textencoding,
                 id3_field_gettextencoding,
                 (union id3_field const* p1))
  ...
  DEFINE_METHOD2(id3_ucs4_t const*,
                 id3_field_getstrings,
                 (union id3_field const* p1, unsigned int p2))
  DEFINE_METHOD1(char const*, id3_field_getframeid, (union id3_field const* p1))
  DEFINE_METHOD2(id3_byte_t const*,
                 id3_field_getbinarydata,
                 (union id3_field const* p1, id3_length_t* p2))
  ...
  DEFINE_METHOD2(const id3_ucs4_t*,
                 id3_metadata_getartist,
                 (const struct id3_tag* p1, enum id3_field_textencoding* p2))
  DEFINE_METHOD2(const id3_ucs4_t*,
                 id3_metadata_getalbum,
                 (const struct id3_tag* p1, enum id3_field_textencoding* p2))
  DEFINE_METHOD2(const id3_ucs4_t*,
                 id3_metadata_getalbumartist,
                 (const struct id3_tag* p1, enum id3_field_textencoding* p2))
  DEFINE_METHOD2(const id3_ucs4_t*,
                 id3_metadata_gettitle,
                 (const struct id3_tag* p1, enum id3_field_textencoding* p2))
  DEFINE_METHOD2(const id3_ucs4_t*,
                 id3_metadata_gettrack,
                 (const struct id3_tag* p1, enum id3_field_textencoding* p2))
  DEFINE_METHOD2(const id3_ucs4_t*,
                 id3_metadata_getpartofset,
                 (const struct id3_tag* p1, enum id3_field_textencoding* p2))
  DEFINE_METHOD2(const id3_ucs4_t*,
                 id3_metadata_getyear,
                 (const struct id3_tag* p1, enum id3_field_textencoding* p2))
  DEFINE_METHOD2(const id3_ucs4_t*,
                 id3_metadata_getgenre,
                 (const struct id3_tag* p1, enum id3_field_textencoding* p2))
  DEFINE_METHOD2(id3_ucs4_list_t*,
                 id3_metadata_getgenres,
                 (const struct id3_tag* p1, enum id3_field_textencoding* p2))
  DEFINE_METHOD2(const id3_ucs4_t*,
                 id3_metadata_getcomment,
                 (const struct id3_tag* p1, enum id3_field_textencoding* p2))
  DEFINE_METHOD2(const id3_ucs4_t*,
                 id3_metadata_getencodedby,
                 (const struct id3_tag* p1, enum id3_field_textencoding* p2))
  DEFINE_METHOD1(char, id3_metadata_getrating, (const struct id3_tag* p1))
  DEFINE_METHOD2(const id3_ucs4_t*,
                 id3_metadata_getcompilation,
                 (const struct id3_tag* p1, enum id3_field_textencoding* p2))
  DEFINE_METHOD2(int, id3_metadata_haspicture, (const struct id3_tag* p1, enum id3_picture_type p2))
  DEFINE_METHOD2(const id3_latin1_t*,
                 id3_metadata_getpicturemimetype,
                 (const struct id3_tag* p1, enum id3_picture_type p2))
  DEFINE_METHOD3(id3_byte_t const*,
                 id3_metadata_getpicturedata,
                 (const struct id3_tag* p1, enum id3_picture_type p2, id3_length_t* p3))
  DEFINE_METHOD3(id3_byte_t const*,
                 id3_metadata_getuniquefileidentifier,
                 (const struct id3_tag* p1, const char* p2, id3_length_t* p3))
  DEFINE_METHOD2(const id3_ucs4_t*,
                 id3_metadata_getusertext,
                 (const struct id3_tag* p1, const char* p2))
  DEFINE_METHOD2(int,
                 id3_metadata_getfirstnonstandardpictype,
                 (const struct id3_tag* p1, enum id3_picture_type* p2))
