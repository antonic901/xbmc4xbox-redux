...
namespace XFILE
{
  ...
  public:
    ...
    static PROGRAMDATABASEDIRECTORY::NODE_TYPE GetDirectoryChildType(const CStdString& strPath);
    static PROGRAMDATABASEDIRECTORY::NODE_TYPE GetDirectoryType(const CStdString& strPath);
    static PROGRAMDATABASEDIRECTORY::NODE_TYPE GetDirectoryParentType(const CStdString& strPath);
    static bool GetQueryParams(const CStdString& strPath, PROGRAMDATABASEDIRECTORY::CQueryParams& params);
    ...
    bool ContainsGames(const CStdString &path);
