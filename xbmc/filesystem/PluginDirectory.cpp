...
void CPluginDirectory::AddSortMethod(int handle, SORT_METHOD sortMethod, const CStdString &label2Mask)
{
  ...
  switch(sortMethod)
  {
    ...
    case SORT_METHOD_PLAYLIST_ORDER:
      {
        CStdString strTrackLeft=CSettings::GetInstance().GetString("musicfiles.trackformat");
        CStdString strTrackRight=CSettings::GetInstance().GetString("musicfiles.trackformatright");
