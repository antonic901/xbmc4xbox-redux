...
public:
   ...
   */
  static std::vector<CVariant> GetList(const boost::shared_ptr<const CSettingList>& settingList);
  /*!
   ...
   */
  static bool SetList(const boost::shared_ptr<CSettingList>& settingList,
  ...
  */
  static bool FindIntInList(const boost::shared_ptr<const CSettingList>& settingList, int value);
};
