...
public:
  ...
  *   \return true if the conversion succeeded, false otherwise.
  */
  static bool ConvertISO6391ToISO6392T(const std::string& strISO6391,
  ...
  */
  ...
  static bool ConvertISO36111Alpha2ToISO36111Alpha3(const std::string& strISO36111Alpha2,
                                                    std::string& strISO36111Alpha3);
  static bool ConvertWindowsLanguageCodeToISO6392T(const std::string& strWindowsLanguageCode,
                                                   std::string& strISO6392T);
#endif
