...
// magic kernel patch, see Trainer_Magic.py
static unsigned char trainerloaderdata[354] =
{
  ,
};

#define SIZEOFLOADERDATA 354// loaderdata is our kernel hack to handle if trainer (com file) is executed for title about to run
#define TRAINER_BASE_OFFSET 0xb
#define DBGPRINT_FUNC_OFFSET 0x3
#define FREE_FUNC_OFFSET 0x9f
...
cleanup:
  ...
  {
    CLog::Log(LOGINFO, "ourmemaddr 0x%08x", ourmemaddr);
    ...
    _asm
    {
      ...
      mov dword ptr [eax+TRAINER_BASE_OFFSET], ebx

      popad
    }

    // patch loaderdata's dbgprint_thunk with the address of DbgPrint
    DWORD dbgPrintAddr = 0;
    _asm
    {
      push eax
      mov eax, [DbgPrint]
      mov dbgPrintAddr, eax
      pop eax
    }
    CLog::Log(LOGINFO, "dbgPrintAddr 0x%08x", dbgPrintAddr);
    memcpy((unsigned char *)ourmemaddr + DBGPRINT_FUNC_OFFSET, &dbgPrintAddr, sizeof(dbgPrintAddr));

    // patch loaderdata to enable/disable freeing the persistent alloc after the trainer runs
    DWORD freeFuncAddr = 0;
    if (trainer.IsPTM())
    {
      _asm
      {
        push eax
        mov eax, [MmFreeContiguousMemory]
        mov freeFuncAddr, eax
        pop eax
      }
      CLog::Log(LOGINFO, "MmFreeContiguousMemory 0x%08x", freeFuncAddr);
    }
    else
    {
      CLog::Log(LOGINFO, "not using etm");
    }
    memcpy((unsigned char *)ourmemaddr + FREE_FUNC_OFFSET, &freeFuncAddr, sizeof(freeFuncAddr));
    ...
    bool bIsXBTF = trainer.IsXBTF();
    unsigned int iTrainerSize = trainer.Size();
    trainer.FreeData();
    ...
    if (bIsXBTF)
    {
      ...
      // adjust past trainer
      ourmemaddr=(PVOID *)(((unsigned int) ourmemaddr) + iTrainerSize);
...
bool CTrainer::Load(const std::string& strPath)
{
  ...
  m_bIsPTM = URIUtils::HasExtension(strPath, ".ptm");

  if (URIUtils::HasExtension(strPath, ".xbtf"))
    m_bIsXBTF = true;
  else if (URIUtils::HasExtension(strPath, ".etm") || m_bIsPTM)
    m_bIsXBTF = false;
  else
  {
    CLog::Log(LOGINFO, "CTrainer::Load: Unsupported trainer extension %s", strPath.c_str());
    return false;
  }
...
bool CTrainer::ScanTrainers()
{
  ...
  CDirectory::GetDirectory(strTrainersPath, trainers, ".xbtf|.etm|.ptm", DIR_FLAG_DEFAULTS);
  ...
  for(int i = 0; i < archives.Size(); i++)
  {
    ...
    { // add trainers in rar
      ...
      {
        if (URIUtils::HasExtension(inArchives[j]->GetURL().Get(), ".xbtf|.etm|.ptm"))
        {
    ...
    { // add trainers in zip
      ...
      CDirectory::GetDirectory(url, zipTrainers, ".xbtf|.etm|.ptm", DIR_FLAG_DEFAULTS);
