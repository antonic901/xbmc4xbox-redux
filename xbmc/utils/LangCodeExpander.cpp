...
bool CLangCodeExpander::ConvertISO6391ToISO6392T(const std::string& strISO6391,
  ...
  if (strCharCode.size() == 3)
  {
    ...
    for (unsigned int index = 0; index < ARRAY_SIZE(LanguageCodes); ++index)
    {
      if (charCode == LanguageCodes[index].iso639_2 ||
          (checkWin32Locales && LanguageCodes[index].win_id != NULL &&
           charCode == LanguageCodes[index].win_id))
      {
...
bool CLangCodeExpander::ConvertISO36111Alpha2ToISO36111Alpha3(const std::string& strISO36111Alpha2,
                                                              std::string& strISO36111Alpha3)
{
...
bool CLangCodeExpander::ConvertWindowsLanguageCodeToISO6392T(
    const std::string& strWindowsLanguageCode, std::string& strISO6392T)
{
...
bool CLangCodeExpander::ConvertToISO6391(const std::string& lang, std::string& code)
{
  ...
  else if (lang.length() == 3)
  {
    ...
    for (unsigned int index = 0; index < ARRAY_SIZE(LanguageCodes); ++index)
    {
      if (lower == LanguageCodes[index].iso639_2 ||
          (LanguageCodes[index].win_id && lower == LanguageCodes[index].win_id))
      {
...
const ISO639 LanguageCodes[189] = {
    {"aa", "aar", NULL},  {"ab", "abk", NULL},  {"af", "afr", NULL},  {"ak", "aka", NULL},
    {"am", "amh", NULL},  {"ar", "ara", NULL},  {"an", "arg", NULL},  {"as", "asm", NULL},
    {"av", "ava", NULL},  {"ae", "ave", NULL},  {"ay", "aym", NULL},  {"az", "aze", NULL},
    {"ba", "bak", NULL},  {"bm", "bam", NULL},  {"be", "bel", NULL},  {"bn", "ben", NULL},
    {"bh", "bih", NULL},  {"bi", "bis", NULL},  {"bo", "tib", NULL},  {"bs", "bos", NULL},
    {"br", "bre", NULL},  {"bg", "bul", NULL},  {"ca", "cat", NULL},  {"cs", "cze", "ces"},
    {"ch", "cha", NULL},  {"ce", "che", NULL},  {"cu", "chu", NULL},  {"cv", "chv", NULL},
    {"kw", "cor", NULL},  {"co", "cos", NULL},  {"cr", "cre", NULL},  {"cy", "wel", NULL},
    {"da", "dan", NULL},  {"de", "ger", "deu"}, {"dv", "div", NULL},  {"dz", "dzo", NULL},
    {"el", "gre", "ell"}, {"en", "eng", NULL},  {"eo", "epo", NULL},  {"et", "est", NULL},
    {"eu", "baq", NULL},  {"ee", "ewe", NULL},  {"fo", "fao", NULL},  {"fa", "per", NULL},
    {"fj", "fij", NULL},  {"fi", "fin", NULL},  {"fr", "fre", "fra"}, {"fy", "fry", NULL},
    {"ff", "ful", NULL},  {"gd", "gla", NULL},  {"ga", "gle", NULL},  {"gl", "glg", NULL},
    {"gv", "glv", NULL},  {"gn", "grn", NULL},  {"gu", "guj", NULL},  {"ht", "hat", NULL},
    {"ha", "hau", NULL},  {"he", "heb", NULL},  {"hz", "her", NULL},  {"hi", "hin", NULL},
    {"ho", "hmo", NULL},  {"hr", "hrv", NULL},  {"hu", "hun", NULL},  {"hy", "arm", NULL},
    {"ig", "ibo", NULL},  {"io", "ido", NULL},  {"ii", "iii", NULL},  {"iu", "iku", NULL},
    {"ie", "ile", NULL},  {"ia", "ina", NULL},  {"id", "ind", NULL},  {"ik", "ipk", NULL},
    {"is", "ice", "isl"}, {"it", "ita", NULL},  {"jv", "jav", NULL},  {"ja", "jpn", NULL},
    {"kl", "kal", NULL},  {"kn", "kan", NULL},  {"ks", "kas", NULL},  {"ka", "geo", NULL},
    {"kr", "kau", NULL},  {"kk", "kaz", NULL},  {"km", "khm", NULL},  {"ki", "kik", NULL},
    {"rw", "kin", NULL},  {"ky", "kir", NULL},  {"kv", "kom", NULL},  {"kg", "kon", NULL},
    {"ko", "kor", NULL},  {"kj", "kua", NULL},  {"ku", "kur", NULL},  {"lo", "lao", NULL},
    {"la", "lat", NULL},  {"lv", "lav", NULL},  {"li", "lim", NULL},  {"ln", "lin", NULL},
    {"lt", "lit", NULL},  {"lb", "ltz", NULL},  {"lu", "lub", NULL},  {"lg", "lug", NULL},
    {"mk", "mac", NULL},  {"mh", "mah", NULL},  {"ml", "mal", NULL},  {"mi", "mao", NULL},
    {"mr", "mar", NULL},  {"ms", "may", NULL},  {"mg", "mlg", NULL},  {"mt", "mlt", NULL},
    {"mn", "mon", NULL},  {"my", "bur", NULL},  {"na", "nau", NULL},  {"nv", "nav", NULL},
    {"nr", "nbl", NULL},  {"nd", "nde", NULL},  {"ng", "ndo", NULL},  {"ne", "nep", NULL},
    {"nl", "dut", "nld"}, {"nn", "nno", NULL},  {"nb", "nob", NULL},  {"no", "nor", NULL},
    {"ny", "nya", NULL},  {"oc", "oci", NULL},  {"oj", "oji", NULL},  {"or", "ori", NULL},
    {"om", "orm", NULL},  {"os", "oss", NULL},  {"pa", "pan", NULL},  {"pi", "pli", NULL},
    {"pl", "pol", "plk"}, {"pt", "por", "ptg"}, {"ps", "pus", NULL},  {"qu", "que", NULL},
    {"rm", "roh", NULL},  {"ro", "rum", "ron"}, {"rn", "run", NULL},  {"ru", "rus", NULL},
    {"sh", "scr", NULL},  {"sg", "sag", NULL},  {"sa", "san", NULL},  {"si", "sin", NULL},
    {"sk", "slo", "sky"}, {"sl", "slv", NULL},  {"se", "sme", NULL},  {"sm", "smo", NULL},
    {"sn", "sna", NULL},  {"sd", "snd", NULL},  {"so", "som", NULL},  {"st", "sot", NULL},
    {"es", "spa", "esp"}, {"sq", "alb", NULL},  {"sc", "srd", NULL},  {"sr", "srp", NULL},
    {"ss", "ssw", NULL},  {"su", "sun", NULL},  {"sw", "swa", NULL},  {"sv", "swe", "sve"},
    {"ty", "tah", NULL},  {"ta", "tam", NULL},  {"tt", "tat", NULL},  {"te", "tel", NULL},
    {"tg", "tgk", NULL},  {"tl", "tgl", NULL},  {"th", "tha", NULL},  {"ti", "tir", NULL},
    {"to", "ton", NULL},  {"tn", "tsn", NULL},  {"ts", "tso", NULL},  {"tk", "tuk", NULL},
    {"tr", "tur", "trk"}, {"tw", "twi", NULL},  {"ug", "uig", NULL},  {"uk", "ukr", NULL},
    {"ur", "urd", NULL},  {"uz", "uzb", NULL},  {"ve", "ven", NULL},  {"vi", "vie", NULL},
    {"vo", "vol", NULL},  {"wa", "wln", NULL},  {"wo", "wol", NULL},  {"xh", "xho", NULL},
    {"yi", "yid", NULL},  {"yo", "yor", NULL},  {"za", "zha", NULL},  {"zh", "chi", "zho"},
    {"zu", "zul", NULL},  {"zv", "und", NULL}, // Kodi intern mapping for missing "Undetermined" iso639-1 code
