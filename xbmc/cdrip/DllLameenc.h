...
{
public:
  virtual int parse_args(lame_global_flags* gfp,
                         int argc,
                         char** argv,
                         char* const inPath,
                         char* const outPath,
  ...
  virtual int lame_encode_buffer_interleaved(lame_global_flags* gfp,
                                             short int pcm[],
                                             int num_samples,
...
class DllLameEnc : public DllDynamic, DllLameEncInterface
{
  ...
  DEFINE_METHOD5(int,
                 ...
                 (lame_global_flags * p1, short int p2[], int p3, unsigned char* p4, int p5))
