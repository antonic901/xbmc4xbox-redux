...
public:
  ...
  virtual int vorbis_analysis_headerout(vorbis_dsp_state* v,
                                        vorbis_comment* vc,
                                        ogg_packet* op,
                                        ogg_packet* op_comm,
                                        ogg_packet* op_code) = 0;
...
class DllVorbis : public DllDynamic, DllVorbisInterface
{
  ...
  DEFINE_METHOD5(
      ...
      (vorbis_dsp_state * p1, vorbis_comment* p2, ogg_packet* p3, ogg_packet* p4, ogg_packet* p5))
