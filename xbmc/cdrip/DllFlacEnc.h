...
public:
  ...
  virtual FLAC__bool FLAC__stream_encoder_set_verify(FLAC__StreamEncoder* encoder,
                                                     FLAC__bool value) = 0;
  virtual FLAC__bool FLAC__stream_encoder_set_compression_level(FLAC__StreamEncoder* encoder,
                                                                unsigned value) = 0;
  virtual FLAC__bool FLAC__stream_encoder_set_channels(FLAC__StreamEncoder* encoder,
                                                       unsigned value) = 0;
  virtual FLAC__bool FLAC__stream_encoder_set_bits_per_sample(FLAC__StreamEncoder* encoder,
                                                              unsigned value) = 0;
  virtual FLAC__bool FLAC__stream_encoder_set_sample_rate(FLAC__StreamEncoder* encoder,
                                                          unsigned value) = 0;
  virtual FLAC__bool FLAC__stream_encoder_set_total_samples_estimate(FLAC__StreamEncoder* encoder,
                                                                     FLAC__uint64 value) = 0;
  virtual FLAC__bool FLAC__stream_encoder_set_metadata(FLAC__StreamEncoder* encoder,
  ...
  virtual FLAC__StreamEncoderInitStatus FLAC__stream_encoder_init_stream(
      ...
      void* client_data) = 0;
  virtual FLAC__bool FLAC__stream_encoder_process_interleaved(FLAC__StreamEncoder* encoder,
  ...
  virtual FLAC__bool FLAC__metadata_object_vorbiscomment_entry_from_name_value_pair(
      FLAC__StreamMetadata_VorbisComment_Entry* entry,
      const char* field_name,
      const char* field_value) = 0;
  virtual FLAC__bool FLAC__metadata_object_vorbiscomment_append_comment(
...
class DllFlacEnc : public DllDynamic, DllFlacEncInterface
{
  ...
  DEFINE_METHOD2(FLAC__bool,
                 FLAC__stream_encoder_set_verify,
                 (FLAC__StreamEncoder * p1, FLAC__bool p2))
  DEFINE_METHOD2(FLAC__bool,
                 FLAC__stream_encoder_set_compression_level,
                 (FLAC__StreamEncoder * p1, unsigned p2))
  DEFINE_METHOD2(FLAC__bool,
  ...
  DEFINE_METHOD2(FLAC__bool,
                 ...
                 (FLAC__StreamEncoder * p1, FLAC__uint64 p2))
  DEFINE_METHOD3(FLAC__bool,
                 FLAC__stream_encoder_set_metadata,
                 (FLAC__StreamEncoder * p1, FLAC__StreamMetadata** p2, unsigned p3))
  DEFINE_METHOD6(FLAC__StreamEncoderInitStatus,
                 FLAC__stream_encoder_init_stream,
                 (FLAC__StreamEncoder * p1,
                  FLAC__StreamEncoderWriteCallback p2,
                  FLAC__StreamEncoderSeekCallback p3,
                  FLAC__StreamEncoderTellCallback p4,
                  FLAC__StreamEncoderMetadataCallback p5,
                  void* p6))
  DEFINE_METHOD3(FLAC__bool,
                 FLAC__stream_encoder_process_interleaved,
                 (FLAC__StreamEncoder * p1, const FLAC__int32 p2[], unsigned p3))
  DEFINE_METHOD1(FLAC__StreamEncoderState,
  ...
  DEFINE_METHOD3(FLAC__bool,
                 ...
                 (FLAC__StreamMetadata_VorbisComment_Entry * p1, const char* p2, const char* p3))
  DEFINE_METHOD3(FLAC__bool,
                 FLAC__metadata_object_vorbiscomment_append_comment,
                 (FLAC__StreamMetadata * p1,
                  FLAC__StreamMetadata_VorbisComment_Entry p2,
                  FLAC__bool p3))
