...
protected:
   ...
   */
  boost::movelib::unique_ptr<CEncoder> SetupEncoder(XFILE::CFile& reader);
   ...
   */
  int RipChunk(XFILE::CFile& reader, const boost::movelib::unique_ptr<CEncoder>& encoder, int& percent);
