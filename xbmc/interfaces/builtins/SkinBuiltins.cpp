...
CBuiltins::CommandMap CSkinBuiltins::GetOperations() const
{
  ...
  CBuiltins::BUILT_IN builtin1 = {"Reload Kodi's skin", 0, ReloadSkin};
  commands.insert(std::make_pair("reloadskin", builtin1));

  CBuiltins::BUILT_IN builtin2 = {"Unload Kodi's skin", 0, UnloadSkin};
  commands.insert(std::make_pair("unloadskin", builtin2));

  CBuiltins::BUILT_IN builtin3 = {"Resets a skin setting to default", 1, SkinReset};
  commands.insert(std::make_pair("skin.reset", builtin3));

  CBuiltins::BUILT_IN builtin4 = {"Resets all skin settings", 0, SkinResetAll};
  commands.insert(std::make_pair("skin.resetsettings", builtin4));

  CBuiltins::BUILT_IN builtin5 = {"Prompts and set an addon", 2, SetAddon};
  commands.insert(std::make_pair("skin.setaddon", builtin5));

  CBuiltins::BUILT_IN builtin6 = {"Prompts and set a skin setting", 2, SelectBool};
  commands.insert(std::make_pair("skin.selectbool", builtin6));

  CBuiltins::BUILT_IN builtin7 = {"Sets a skin setting on", 1, SetBool};
  commands.insert(std::make_pair("skin.setbool", builtin7));

  CBuiltins::BUILT_IN builtin8 = {"Prompts and sets a file", 1, SetFile};
  commands.insert(std::make_pair("skin.setfile", builtin8));
