...
CBuiltins::CommandMap CGUIContainerBuiltins::GetOperations() const
{
  ...
  commands.insert(std::make_pair("container.refresh", builtin5));

  CBuiltins::BUILT_IN builtin6 = {"Toggle the sort direction", 0, ToggleSortDirection};
  commands.insert(std::make_pair("container.setsortdirection", builtin6));

  CBuiltins::BUILT_IN builtin7 = {"Change to the specified sort method", 1, SetSortMethod};
  commands.insert(std::make_pair("container.setsortmethod", builtin7));
