    ...
    int totalItems)
{
  ...
  for (std::vector<Tuple<String, const XBMCAddon::xbmcgui::ListItem*, bool> >::const_iterator it =
           items.begin();
       it != items.end(); ++it)
  {
    const XBMCAddon::Tuple<XBMCAddon::String, const XBMCAddon::xbmcgui::ListItem*, bool>& item =
        *it;
