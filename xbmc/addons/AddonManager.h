...
public:
  ...
  static bool Factory(const cp_plugin_info_t* plugin,
                      TYPE type,
                      CAddonBuilder& builder,
                      bool ignoreExtensions = false,
                      const CRepository::DirInfo& repo = CRepository::DirInfo());
  static void FillCpluffMetadata(const cp_plugin_info_t* plugin,
                                 CAddonBuilder& builder,
