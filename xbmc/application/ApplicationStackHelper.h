...
public:
  ...
  */
  boost::optional<int> InitializeStackStartPartAndOffset(const CFileItem& item);
  ...
  */
  boost::shared_ptr<const CFileItem> GetRegisteredStack(const CFileItem& item) const;
  ...
  */
  void SetRegisteredStack(const CFileItem& item, boost::shared_ptr<CFileItem> stackItem);
...
protected:
  ...
  */
  ...
  public:
    ...
    boost::shared_ptr<CFileItem> m_pStack;
  };

  typedef boost::shared_ptr<StackPartInformation> StackPartInformationPtr;
  ...
  boost::movelib::unique_ptr<CFileItemList> m_currentStack;
