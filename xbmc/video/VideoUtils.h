...
{
  ResumeInformation() : isResumable(false), startOffset(0), partNumber(0) {}
  bool isResumable; // the playback of the item can be resumed
  int64_t startOffset; // a start offset
  int partNumber; // a part number
};
