...
public:
  ...
  // Use only on Xbox to execute SQL query using Web Server
  bool GetArbitraryQuery(const std::string& strQuery,
  ...
  void UpdateFileDateAdded(int idFile,
                           const std::string& strFileNameAndPathh,
                           const CDateTime& dateAdded = CDateTime());
  ...
  // partymode
  unsigned int GetMusicVideoIDs(const std::string& strWhere,
...
protected:
  ...
  CVideoInfoTag GetDetailsForMovie(boost::movelib::unique_ptr<dbiplus::Dataset>& pDS,
                                   int getDetails = VideoDbDetailsNone);
  CVideoInfoTag GetDetailsForMovie(const dbiplus::sql_record* const record,
                                   int getDetails = VideoDbDetailsNone);
  CVideoInfoTag GetDetailsForTvShow(boost::movelib::unique_ptr<dbiplus::Dataset>& pDS,
                                    int getDetails = VideoDbDetailsNone,
                                    CFileItem* item = NULL);
  CVideoInfoTag GetDetailsForTvShow(const dbiplus::sql_record* const record,
                                    int getDetails = VideoDbDetailsNone,
                                    CFileItem* item = NULL);
  CVideoInfoTag GetDetailsForEpisode(boost::movelib::unique_ptr<dbiplus::Dataset>& pDS,
                                     int getDetails = VideoDbDetailsNone);
  CVideoInfoTag GetDetailsForEpisode(const dbiplus::sql_record* const record,
                                     int getDetails = VideoDbDetailsNone);
  CVideoInfoTag GetDetailsForMusicVideo(boost::movelib::unique_ptr<dbiplus::Dataset>& pDS,
                                        int getDetails = VideoDbDetailsNone);
  ...
  void GetDetailsFromDB(boost::movelib::unique_ptr<dbiplus::Dataset>& pDS,
                        int min,
                        int max,
