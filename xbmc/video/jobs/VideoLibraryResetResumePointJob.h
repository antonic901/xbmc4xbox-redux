...
public:
  ...
  */
  CVideoLibraryResetResumePointJob(const boost::shared_ptr<CFileItem>& item);
  virtual ~CVideoLibraryResetResumePointJob() {}

  virtual const char *GetType() const { return "CVideoLibraryResetResumePointJob"; }
