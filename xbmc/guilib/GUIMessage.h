 ...
 */
#define GUI_MSG_RESET_MULTI_IMAGE     53
...
public:
  ...
  CGUIMessage(int msg,
              ...
              int64_t param1,
              int64_t param2,
              const boost::shared_ptr<CGUIListItem>& item);
  ...
  boost::shared_ptr<CGUIListItem> GetItem() const;
  int GetParam1() const;
  ...
  void SetItem(boost::shared_ptr<CGUIListItem> item);
...
private:
  ...
  int64_t m_param1;
  int64_t m_param2;
  boost::shared_ptr<CGUIListItem> m_item;
