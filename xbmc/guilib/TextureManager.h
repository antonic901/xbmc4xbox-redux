...
public:
  ...
  void Add(boost::shared_ptr<CTexture> texture, int delay);
  void Set(boost::shared_ptr<CTexture> texture, int width, int height);
  void Free();
  unsigned int size() const;

  std::vector<boost::shared_ptr<CTexture> > m_textures;
...
public:
  ...
  void Add(boost::movelib::unique_ptr<CTexture> texture, int delay);
  bool Release();
...
protected:
  ...
  std::list<std::pair<CTextureMap*, unsigned int> >
      m_unusedTextures;
