...
#define KEY_ASCII \
  0xF100 // a printable character in the range of TRUE ASCII (from 0 to 127) // FIXME make it clean and pure unicode! remove the need for KEY_ASCII
#define KEY_UNICODE \
...
#define ACTION_SHOW_CODEC \
  27 // show information about file. Can b used in videoFullScreen.xml window id=2005 and in slideshow.xml window id=2007
...
#define ACTION_ANALOG_MOVE \
  49 // analog thumbstick move. Can b used in: slideshow.xml window id=2007/settingsScreenCalibration.xml windowid=11/settingsUICalibration.xml windowid=10
...
#define ACTION_OSD_SHOW_LEFT \
  69 // Move left in OSD. Can b used in videoFullScreen.xml window id=2005
#define ACTION_OSD_SHOW_RIGHT \
  70 // Move right in OSD. Can b used in videoFullScreen.xml window id=2005
#define ACTION_OSD_SHOW_UP 71 // Move up in OSD. Can b used in videoFullScreen.xml window id=2005
#define ACTION_OSD_SHOW_DOWN \
  72 // Move down in OSD. Can b used in videoFullScreen.xml window id=2005
#define ACTION_OSD_SHOW_SELECT \
  73 // toggle/select option in OSD. Can b used in videoFullScreen.xml window id=2005
#define ACTION_OSD_SHOW_VALUE_PLUS \
  74 // increase value of current option in OSD. Can b used in videoFullScreen.xml window id=2005
#define ACTION_OSD_SHOW_VALUE_MIN \
  75 // decrease value of current option in OSD. Can b used in videoFullScreen.xml window id=2005
...
#define ACTION_SHOW_MPLAYER_OSD \
  83 // toggles mplayers OSD. Can be used in videofullscreen.xml window id=2005
#define ACTION_OSD_HIDESUBMENU \
  84 // removes an OSD sub menu. Can be used in videoOSD.xml window id=2901
...
#define WINDOW_FULLSCREEN_LIVETV \
  10614 // virtual window for PVR specific keymap bindings in fullscreen playback (which internally uses WINDOW_FULLSCREEN_VIDEO)
#define WINDOW_FULLSCREEN_RADIO \
  10625 // virtual window for PVR radio specific keymaps with fallback to WINDOW_VISUALISATION
...
public:
  ...
  wchar_t GetUnicode()
      const; // http api does not really support unicode till now. It only simulates unicode when ascii codes are available:
