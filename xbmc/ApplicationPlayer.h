...
class CApplicationPlayer
{
  ...
  unsigned int
      m_iPlayerOPSeq; // used to detect whether an OpenFile request on player is canceled by us.
...
public:
  ...
  void SetPlaySpeed(
      ...
      bool bApplicationMuted =
          false); // bApplicationMuted is not used in DVD/PAPlayer so value can be ignored
