...
public:
  ...
  boost::movelib::unique_ptr<CTexture> Load(const std::string& specialType,
                                 const std::string& filePath,
                                 unsigned int preferredWidth,
                                 unsigned int preferredHeight) const;

private:
  boost::array<boost::movelib::unique_ptr<ISpecialImageFileLoader>, 5> m_specialImageLoaders;
};
} // namespace IMAGE_FILES
