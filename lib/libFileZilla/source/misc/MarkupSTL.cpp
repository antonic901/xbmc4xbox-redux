...
bool CMarkupSTL::RestorePos( LPCTSTR szPosName )
{
    ...
    std::map<std::string, SavedPos>::iterator iter=m_mapSavedPos.find( szPosName );
...
std::string CMarkupSTL::x_GetAttrib( int iPos, LPCTSTR szAttrib ) const
{
...
bool CMarkupSTL::x_CreateNode( std::string& csNode, int nNodeType, LPCTSTR szText )
{
...
std::string CMarkupSTL::x_TextToDoc( LPCTSTR szText, bool bAttrib ) const
{
...
void CMarkupSTL::x_DocChange( int nLeft, int nReplace, const std::string& csInsert )
{
