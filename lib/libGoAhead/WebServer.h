...
int XbmcWebsHttpAPIConfigBookmarkSize(std::string& response, int argc, char_t **argv);
int XbmcWebsHttpAPIConfigGetBookmark(std::string& response, int argc, char_t **argv);
int XbmcWebsHttpAPIConfigAddBookmark(std::string& response, int argc, char_t **argv);
int XbmcWebsHttpAPIConfigSaveBookmark(std::string& response, int argc, char_t **argv);
int XbmcWebsHttpAPIConfigRemoveBookmark(std::string& response, int argc, char_t **argv);
int XbmcWebsHttpAPIConfigSaveConfiguration(std::string& response, int argc, char_t **argv);
int XbmcWebsHttpAPIConfigGetOption(std::string& response, int argc, char_t **argv);
int XbmcWebsHttpAPIConfigSetOption(std::string& response, int argc, char_t **argv);
